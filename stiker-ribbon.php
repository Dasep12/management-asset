...
<div id="container">
  ...
  <div class="box-header" style="position: absolute;top: 190px;border-top: none;">
    <h5>Entri Stiker Ribbon (Otomatis)</h5>
    </div><br>
    <div class="box-add">
      <form name="datetimepicker" action="" method="POST">
      <input type="hidden" name="jam" value=<?php  date('Ymd hi') ;?>>
      <input type="hidden" name="id_barang" value="1">
      <input type="hidden" name="user" >
      <input type="hidden" name="kode" value=<?php echo "SR".  date('ymds')."G012"; ?>>
      <input type="hidden" name="stiker" value="1"><input type="hidden" name="ribbon" value="1">
        ...
        <label>Tanggal Pergantian</label><input type="text"  class="box-input" style="width: 50%;" value="<?php echo  date('Y-m-d');?>" name="tanggal" placeholder="Tanggal" id="datetime">
