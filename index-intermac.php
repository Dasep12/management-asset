...
<span><marquee direction="left">All intermac</marquee></span>
 <li>
<?php
include 'waktu.php';
?>
...
<script>
 ...
 <div class="box-header">
    <h5>Master Data Intermac</h5>
  <div class="box-pinjam" style="position: absolute;left: -1px;"><br>
    <a href="add-intermac.php" target="_new"><button class="btn btn-default btn-sm">Entri Data <i class="fa fa-plus"></i></button></a>
    <a href="javascript:buka_print();"><button class="btn btn-default btn-sm">Print <i class="fa fa-print"></i></button></a>
    <a href="export-intermac.php" target="_new"><button class="btn btn-default btn-sm">Excel <i class="fa fa-file-excel"></i></button></a>
    ...
    <a href='#upload_modal' data-id=<?php echo $data->Ambil_id();?> data-toggle='modal'><button class="btn btn-default btn-sm">Upload <i class="fa fa-upload"></i></button></a>
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM intermac ORDER BY id ");
        ...
        <div class="informasi">
          ...
          <!--Grafik Untuk intermac Cadangan-->
          ...
          <!--Grafik Untuk intermac Aktif-->
            <?php $data = "SELECT * FROM intermac WHERE status='aktif'";
            $r = mysqli_query($koneksi,$data);
...
<!--Modal Upload Data Intermac-->
    <div class="modal fade" id="upload_modal" role="dialog" style="">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Upload Data Intermac</h4>
                </div>
                <div class="modal-body">
                    <div class="hasil-data"></div>
                </div>
