...
<span>Beranda / scanner / Entri Data </span>
 <li>
<?php
include 'waktu.php';
?>
...
<div id="container">
  <div class="box-header">
    ...
    <div class="box-add">
      ...
      <label>Tipe</label><input type="text"  style="width: 8%;" class="box-input" placeholder="RAM" name="type" >
      <label>Posisi</label>
