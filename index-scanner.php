...
<div id="container">
  <div class="box-header">
    <h5>Master Data scanner</h5>
<script>
  function buka_print(){
  window.open('data-scanner.php' ,'' ,'menubar=yes','resizeabel=yes','height=480px','width=600px');
}
</script>
  <div class="box-pinjam" style="position: absolute;left: -1px;"><br>
    <a href="add-scanner.php" target="_new"><button class="btn btn-default btn-sm">Entri Data <i class="fa fa-plus"></i></button></a>
    <a href="javascript:buka_print()"><button class="btn btn-default btn-sm">Print <i class="fa fa-print"></i></button></a>
    <a href="export-scanner.php" target="_new"><button class="btn btn-default btn-sm">Excel <i class="fa fa-file-excel"></i></button></a>
    ...
    <a href='#upload_modal' data-id=<?php echo $data->Ambil_id();?> data-toggle='modal'><button class="btn btn-default btn-sm">Upload <i class="fa fa-upload"></i></button></a>
        ...
        <div class="informasi">
          ...
          <!--Grafik Untuk scanner Cadangan-->
            <?php $data = "SELECT * FROM scanner WHERE status='cadangan'";
          ...
          <!--Grafik Untuk scanner Rusak-->
            <?php $data = "SELECT * FROM scanner WHERE status='rusak'";
            $r = mysqli_query($koneksi,$data);
          ...
          <!--Grafik Untuk scanner Service-->
            <?php $data = "SELECT * FROM scanner WHERE status='service'";
            $r = mysqli_query($koneksi,$data);
          ...
          <!--Grafik Untuk scanner Aktif-->
            <?php $data = "SELECT * FROM scanner WHERE status='aktif'";
            $r = mysqli_query($koneksi,$data);
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Detail scanner</h4>
                </div>
    ...
    <div class="modal fade" id="upload_modal" role="dialog" style="">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Upload Data scanner</h4>
                </div>
                <div class="modal-body">
                    <div class="hasil-data"></div>
                </div>
