...
<span><marquee direction="left">Printer Aktif & Cadangan</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<ul>
  <li><a class="fa fa-laptop"></a><a href=""> printer</a></li>
...
<script type="text/javascript">
  function print(){
    window.open('data-printer.php','menubar=yes','resizeable=yes')
  }
</script>
  <nav class="navbar" style="margin-top: 50px;">
  <li style="float: left;width: 10%;padding:8.5px; letter-spacing: .1em;text-align: center;cursor: unset;">Data Printer</li>
  <li style="margin-right: 0px;"><a href="add-printer.php"> Tambah Data  <i style="font-size: 19px; margin-bottom: -3px; color: #ccc;" class="fa fa-plus"></i></a></li>
  <li><a href="export-printer.php"> Export To CSV <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-file-excel"></i></a></li>
  <li><a href="javascript:print()"> Print <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-print"></i></a></li>
</nav>
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                            <div class="form-group" style="border: 2px solid silver; ">
                               <div class="sub-type">
                                  <li>
                                    <a href="index-printer.php">
                                     <?php $data = "SELECT * FROM printer";
                                  ...
                                  <li  class="active">
                                    <a href="index-printer-baik.php">
                                      <?php $data = "SELECT * FROM printer WHERE status='aktif' or status='cadangan'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);      
                                      echo "Baik ($count_r)";?>
                                    </a>    
                                  ...
                                  <li>
                                    <a href="index-printer-rusak.php">
                                  ...
                                  <li>
                                    <a href="index-printer-service.php">
                                  ...
                                  <li>
                                    <a href="index-printer-cadangan.php">
                    ...
                    <?php
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM printer WHERE status='aktif' or status='cadangan' ");
