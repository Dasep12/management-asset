...
/* calendar */
table.calendar		{ border-left:1px solid #999;width:500px; }
tr.calendar-row	{  }
td.calendar-day	{ min-height:80px; font-size:13px; position:relative; } 
* html div.calendar-day { height:80px; }
td.calendar-day:hover	{ background:#eceff5; }
td.calendar-day-np	{ background:#eee; min-height:80px; } 
* html div.calendar-day-np { height:80px; }
td.calendar-day-head { background-color: #228b22; font-weight:bold; text-align:center; width:120px; padding:5px; border-bottom:1px solid #999; border-top:1px solid #999; border-right:1px solid #999;color:#fff; }
div.day-number		{ background:#999; padding:5px; color:#fff; font-weight:bold; float:right; margin:-5px -5px 0 0; width:20px; text-align:center; }
div.today-number		{ background:#33CC00; padding:5px; color:#fff; font-weight:bold; float:right; margin:-5px -5px 0 0; width:20px; text-align:center; }
/* shared */
...
echo '<h3><a href="http://www.zainalhakim.web.id/download/contoh-membuat-kalender-dengan-php.html">DOWNLOAD</a></h3>
<h3><a href="http://www.zainalhakim.web.id">www.zainalhakim.web.id</a></h3>';
?>
</div>
</body>
</html>
