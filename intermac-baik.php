...
<span><marquee direction="left">Intermac Baik</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<ul>
  ...
  <li><a class="fa fa-tv"></a> <a href=""> intermac</a></li>
...
<script>
  function buka_print(){
  window.open('data-intermac.php' ,'' ,'menubar=yes','resizeabel=yes','height=480px','width=600px');
}
</script>
<div id="container">
  <nav class="navbar" style="margin-top: 50px;">
  <li style="float: left;width: 10%;padding:8.5px; letter-spacing: .1em;text-align: center;cursor: unset;">Data intermac</li>
  <li style="margin-right: 0px;"><a href="add-intermac.php"> Tambah Data  <i style="font-size: 19px; margin-bottom: -3px; color: #ccc;" class="fa fa-plus"></i></a></li>
  <li><a href="export-intermac.php"> Export To CSV <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-file-excel"></i></a></li>
...
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                            <div class="form-group" style="border: 2px solid gray;">
                               <div class="sub-type">
                                  <li>
                                    <a href="index-intermac.php?all_data">
                                     <?php $data = "SELECT * FROM intermac";
                                  ...
                                  <li class="active">
                                    <a href="intermac-baik.php?=m&view=intermacbaik">
                                      <?php $data = "SELECT * FROM intermac WHERE status='aktif' or status='cadangan'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                      echo "Baik ($count_r)"?>
                                    </a>    
                                  ...
                                  <li>
                                    <a href="intermac-rusak.php?=m&view=intermacrusak">
                                      <?php $data = "SELECT * FROM intermac WHERE status='rusak'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                      echo "Rusak ($count_r)"?>                                      
                                    </a>
                                  ...
                                  <li>
                                    <a href="intermac-service.php?=m&view=intermacservice">
                                      <?php $data = "SELECT * FROM intermac WHERE status='service'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                  ...
                                  <li>
                                    <a href="intermac-cadangan.php?=m&view=intermaccadangan">
                                      <?php $data = "SELECT * FROM intermac WHERE status='cadangan'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM intermac WHERE status='aktif' or status='cadangan' ");
                      while($row = mysqli_fetch_array($result)) {?>
                                        <tr class="">
                                            ...
                                            <td><a onclick="return confirm('Yakin Hapus')" href="delete-intermac.php?id=<?=$row['id']?>"><i style="font-size: 16px; color:#26ab37; " class='fa fa-trash-alt'></i></a> / 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Detail Intermac</h4>
                </div>
