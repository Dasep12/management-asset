...
<span><marquee direction="left">Intermac Cadangan</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                               ...
                               <div class="sub-type">
                                  ...
                                  <li>
                                    <a href="intermac-baik.php?=m&view=intermacbaik">
                                      <?php $data = "SELECT * FROM intermac WHERE status='cadangan' or status='aktif'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                      echo "Baik ($count_r)"?>
                                    </a>    
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM intermac WHERE status='cadangan' ");
