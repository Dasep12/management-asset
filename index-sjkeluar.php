...
<br><br><br><br>
            <div class="panel-body">
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM sj_keluar WHERE type_sj='keluar'  ");
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content-1">
                ...
                <div class="modal-footer">
                   <button type="button" style="z-index: 99;position: relative;" class="btn btn-info" data-dismiss="modal">Keluar</button>
                </div>
            </div>
        </div>
    </div>
