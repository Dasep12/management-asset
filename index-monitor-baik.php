...
<span><marquee direction="left">Monitor Aktif & Cadangan</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<script type="text/javascript">
  function print(){
    window.open('data-monitor.php','resizeable=yes','menubar=yes',)
  }
</script>
  <nav class="navbar" style="margin-top: 50px;">
  <li style="float: left;width: 10%;padding:8.5px; letter-spacing: .1em;text-align: center;cursor: unset;">Data Monitor</li>
  <li style="margin-right: 0px;"><a href="add-monitor.php"> Tambah Data  <i style="font-size: 19px; margin-bottom: -3px; color: #ccc;" class="fa fa-plus"></i></a></li>
  <li><a href="export-monitor.php"> Export To CSV <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-file-excel"></i></a></li>
  <li><a href="javascript:print()" target="_new"> Print <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-print"></i></a></li>
</nav>
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                            <div class="form-group" style="border: 2px solid gray;">
                               <div class="sub-type">
                                  <li>
                                    <a href="index-monitor.php?all_data">
                                     <?php $data = "SELECT * FROM monitor";
                                  ...
                                  <li class="active">
                                    <a href="index-monitor-baik.php?monitor_baik">
                                      <?php $data = "SELECT * FROM monitor WHERE status='aktif' or status='cadangan'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);        
                                      echo "Baik ($count_r)"?>
                                    </a>    
                                  ...
                                  <li>
                                    <a href="index-monitor-rusak.php?monitor_rusak">
                                  ...
                                  <li>
                                    <a href="index-monitor-service.php?monitor_service">
                                  ...
                                  <li>
                                    <a href="index-monitor-cadangan.php?monitor_cadangan">
                    ...
                    return $hasil_rupiah;
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM monitor WHERE status='aktif' or status='cadangan'");
                      while($row = mysqli_fetch_array($result)) {?>
                                        <tr class="">
                                            ...
                                            <td><a onclick="return confirm('Yakin Hapus')" href="delete-monitor.php?id=<?=$row['id']?>"><i style="font-size: 16px; color:#26ab37; " class='fa fa-trash-alt'></i></a> / 
