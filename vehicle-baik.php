...
<ul>
  ...
  <li><a class="fa fa-tv"></a> <a href=""> vehicle</a></li>
...
<div id="container">
  ...
  <li style="float: left;width: 10%;padding:8.5px; letter-spacing: .1em;text-align: center;cursor: unset;">Data vehicle</li>
  <li style="margin-right: 0px;"><a href="add-vehicle.php"> Tambah Data  <i style="font-size: 19px; margin-bottom: -3px; color: #ccc;" class="fa fa-plus"></i></a></li>
  <li><a href="export-vehicle.php"> Export To CSV <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-file-excel"></i></a></li>
...
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                            <div class="form-group" style="border: 2px solid gray;">
                               <div class="sub-type">
                                  <li>
                                    <a href="index-vehicle.php?all_data">
                                     <?php $data = "SELECT * FROM vehicle";
                                  ...
                                  <li class="active">
                                    <a href="vehicle-baik.php?=m&view=vehiclebaik">
                                      <?php $data = "SELECT * FROM vehicle WHERE status='aktif' or status='cadangan'";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                      echo "Baik ($count_r)"?>
                                    </a>    
                                  ...
                                  <li>
                                    <a href="vehicle-rusak.php?=m&view=vehiclerusak">
                                  ...
                                  <li>
                                    <a href="vehicle-service.php?=m&view=vehicleservice">
                                  ...
                                  <li>
                                    <a href="vehicle-cadangan.php?=m&view=vehiclecad">
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM vehicle WHERE status='aktif' or status='cadangan' ");
