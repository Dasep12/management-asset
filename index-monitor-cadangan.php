...
<span><marquee direction="left">LCD/LED Rusak</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<script type="text/javascript">
  function print(){
  window.open('data-monitor.php','','menubar=yes','resizeable=yes')
  }
</script>
...
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                    ...
                    return $hasil_rupiah;
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM monitor WHERE status='cadangan'");
