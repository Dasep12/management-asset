    ...
    if($_POST['idx']) {
        ...
        ?>
        		...
        		<h1><i style="color: rgba(250,12,0,0.8);font-size: 90px;" class="fa fa-trash"></i></h1>
                    ...
                    <a href="delete-monitor.php?id=<?=$result['id']?>" ><button style="width: 90%" class="btn btn-primary btn-sm"  type="submit">Ya, saya ingin menghapus data ini permanen</button></a><br>
