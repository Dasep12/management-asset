...
<span><marquee direction="left">Monitor Service</marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<script type="text/javascript">
  ...
  <li><a href="javascript:print()" target="_new"> Printout <i style="font-size: 19px; color: #ccc; margin-bottom: -3px; " class="fa fa-print"></i></a></li>
</nav>
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                    ...
                    return $hasil_rupiah;
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM monitor WHERE status='service'");
