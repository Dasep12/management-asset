...
include'koneksi/koneksi.php';
    if(isset($_POST['simpan'])){
        ...
        $data = mysqli_query($koneksi,"SELECT * FROM komputer WHERE ip='$_POST[ip]' or sn='$_POST[sn]'");
        $count = mysqli_num_rows($data);
            if($count>0){
                    ...
                    $qry="INSERT INTO komputer(merk,sn,aktiva,ram,procesor,ip,posisi,status,tahun_p,biaya_p,nilai_aktiva,ket,tgl_update)VALUES('$merk','$sn','$aktiva','$ram','$procesor','$ip','$posisi','$status','$tahun','$biaya','$nilai_aktiva','$ket','$update')";
