...
<span><marquee direction="left">Tabel Surat Jalan Keluar Support DC-G001</marquee></span>
 <li>
<?php
...
<div id="container"><br>
<div class="sub-type-1">
<ul>
    <li  >
      <a href="surat-jalan.php">
        <?php
          include 'koneksi/koneksi.php';
          $data = mysqli_query($koneksi, "SELECT * FROM sj_keluar");
          $count = mysqli_num_rows($data);
          echo "Surat Jalan All ($count)";

        ?>
      </a>
    </li>
    <li>
      <a href="index-sjkeluar.php">
        <?php
          include 'koneksi/koneksi.php';
          $data = mysqli_query($koneksi, "SELECT * FROM sj_keluar WHERE type_sj='keluar'  ");
          $count = mysqli_num_rows($data);
          echo "Surat Jalan Keluar ($count)";

        ?>
      </a>
    </li>
    <li  class="active">
      <a href="index-sjmasuk.php">
        <?php
          include 'koneksi/koneksi.php';
          $data = mysqli_query($koneksi, "SELECT * FROM sj_keluar WHERE type_sj='masuk'  ");
          $count = mysqli_num_rows($data);
          echo "Surat Jalan Masuk ($count)";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content-1">
                ...
                <div class="modal-footer">
                 <button type="button" style="z-index: 9;position: relative;" class="btn btn-info" data-dismiss="modal">Keluar</button>
                </div>
            </div>
        </div>
    </div>
