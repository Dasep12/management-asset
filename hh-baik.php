...
<span><marquee direction="left">Handheld Aktif / Cadangan </marquee></span>
 <li>
<?php
function bulan(){
$bulan =date('m');
...
<div id="container">
  ...
  <li style="margin-right: 0px;"><a href="add-handheld.php"> Tambah Data  <i style="font-size: 19px; margin-bottom: -3px; color: #26ab90;" class="fa fa-plus"></i></a></li>
  <li><a href="export-handheld.php"> Export To CSV <i style="font-size: 19px; color: green; margin-bottom: -3px; " class="fa fa-file-excel"></i></a></li>
...
<br><br><br><br>
            <div class="panel-body" style="margin-top: -80px;">
                            <div class="form-group" style="border: 2px solid gray;">
                               <div class="sub-type">
                                  <li >
                                    <a href="index-handheld.php?=m&view=hhbaik">
                                  ...
                                  <li class="active">
                                    <a href="hh-baik.php?=m&view=hhbaik">
                                      <?php $data = "SELECT * FROM handheld WHERE status='aktif' or status='cadangan' ";
                                      $r = mysqli_query($koneksi,$data);
                                      $count_r = mysqli_num_rows($r);                                     
                                      echo "Baik ($count_r)"?>
                                    </a>    
                    ...
                    include ('koneksi/koneksi.php');
                      ...
                      $result = mysqli_query($koneksi, "SELECT * FROM handheld WHERE status='cadangan' or status='aktif'  ");
